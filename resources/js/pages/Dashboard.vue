...
const breadcrumbs: BreadcrumbItem[] = [{ title: '', href: '/admin' }];
</script>
    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            ...
            <div class="grid grid-cols-1 gap-6 md:grid-cols-3">
                <div
                    class="relative aspect-video overflow-hidden rounded-2xl border border-blue-200 bg-white shadow-md transition-all hover:shadow-lg dark:border-slate-700 dark:bg-slate-800"
                >
            ...
            <!-- Panel Besar -->
            <div
                class="relative min-h-[400px] rounded-2xl border border-blue-200 bg-white p-4 shadow-md transition-all hover:shadow-lg dark:border-slate-700 dark:bg-slate-800"
            >
