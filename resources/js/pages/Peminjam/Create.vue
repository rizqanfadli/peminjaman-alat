...
const breadcrumbs: BreadcrumbItem[] = [
  ...
  { title: 'Tambah Peminjam', href: '/peminjam/create' },
];

const form = useForm({
  nama_siswa: '',
  kelas: '',
  tanggal_peminjaman: new Date().toISOString().split('T')[0],
  nama_barang: '',
  jumlah_barang: 1,
  keterangan: '',
  status: 'Dipinjam',
...
<template>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    >
      ...
      <!-- Form -->
      <div class="mx-auto w-full max-w-4xl rounded-xl border border-blue-200 bg-white p-8 shadow-md dark:border-slate-700 dark:bg-slate-800">
