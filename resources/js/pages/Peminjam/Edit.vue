    ...
    <AppLayout :breadcrumbs="breadcrumbs">
        ...
        >
            <form @submit.prevent="submit" class="space-y-6">
                <!-- Nama Siswa -->
                <div>
                    <Label for="nama_siswa" class="font-semibold text-blue-700 dark:text-blue-300">Nama Siswa</Label>
                    <Input
                        id="nama_siswa"
                        type="text"
                ...
                <!-- Jumlah Barang -->
                <div>
                    <Label for="jumlah_barang" class="font-semibold text-blue-700 dark:text-blue-300">Jumlah Barang</Label>
                    <Input
                        id="jumlah_barang"
                        type="number"
                        class="mt-1 block w-full rounded-md border border-blue-300 transition focus:border-blue-500 focus:ring-2 focus:ring-blue-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
